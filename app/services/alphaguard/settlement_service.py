    ...
    async def _prepare(
        ...
        *,
        ...
        record = SettlementRecord(
            ...
            experiment_id=fill.experiment_id,
            assignment_id=fill.assignment_id,
            challenger_version_id=fill.challenger_version_id,
            baseline_champion_id=fill.baseline_champion_id,
            config_hash=fill.config_hash,
